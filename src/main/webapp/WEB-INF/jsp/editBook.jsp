...
<nav class="navbar">
    <div class="nav-menu">
        <ul class="menu">
            ...
            <li><a href="/goBookStore.do">所有商品</a></li>
            <li><a href="/goAskBookStore.do">求购区</a></li>
            <li><a href="#">这是编辑商品页</a></li>
        </ul>
    </div><!-- nav-menu -->

    <form class="nav-search">
        <input type="search" class="searchIn" name="name" placeholder="搜商品...">
        <button class="search-logo"><img src="<%=request.getContextPath()%>/img/search2.png"></button>
    </form>

    <div class="nav-info">
        <a href="#" class="username">${user.getName()}</a>
        <a href="/myBookshelf.do" class="bookshelf">||&nbsp;&nbsp;&nbsp;我的商品</a>
...
<div class="container">
    <form enctype="multipart/form-data" id="bookForm">
        ...
        <p>
            ...
            商 品 图 片： <input type="file" id="book-file" name="image">
            <img id="book-pic" src="<%=request.getContextPath()%>/img/book-list/article/${book.getBookImage().getId()}.jpg">
        </p>
        <p>
            <span class="name-icon">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名：<input type="text" name="name" value="${book.getName()}" id="bookName">
        </p>
        <%--        <p>--%>
        ...
        <p>
            ...
            商&nbsp;品&nbsp;&nbsp;原&nbsp;价：<input type="text" name="originalPrice" value="${book.getOriginalPrice()}" id="bookOriginalPrice">
        </p>
        <p>
            <span class="price-icon">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            商&nbsp;品&nbsp;&nbsp;售&nbsp;价：<input type="text" name="price" value="${book.getPrice()}" id="bookPrice">
        </p>
        <%--        <p>--%>
        ...
        <p>
            ...
            商&nbsp;品&nbsp;&nbsp;描&nbsp;述：<input type="text" name="description" value="${book.getDescription()}" id="bookDescription">
        </p>
